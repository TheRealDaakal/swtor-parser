...
def rotation_segments(lines, player_name: str, keyword: str) -> List[dict]:
    ...
    within each segment: DPS, EHPS, crit%, and the ordered sequence of
    casts landed. Answers "how did my rotation look between each
    occurrence of this mechanic" -- e.g. keyed to a recurring boss
    ability, this shows the burst window between each occurrence.
        ...
        for t, event in parsed:
            ...
            if is_attack:
                ...
                if event.amount:
                    ...
                    casts.append({"ability": event.ability or event.effect_name or "Unknown",
